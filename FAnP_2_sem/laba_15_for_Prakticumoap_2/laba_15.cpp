//Паркинг.Реализовать хеш - таблицу со следующими полями :
//№ места, владельца места.Ключ – № места.
#include <iostream>
#include <string>
using namespace std;
...
int main() {
	...
	for (;;) {
		...
		{
		case 1:
			cout << "Введите название места: " << endl;
			cin.ignore();
			getline(cin, tmp);
		...
		case 2:
			cout << "Введите название места(ключ), который хотите удалить из хеш-таблицы: " << endl;
			cin >> tmp;
